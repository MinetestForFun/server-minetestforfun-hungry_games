...
minetest.register_tool("shields:shield_steel", {
	...
	groups = {armor_shield=5, armor_heal=2, armor_use=500},
	wear = 0,
})
...
minetest.register_tool("shields:shield_bronze", {
	...
	groups = {armor_shield=7, armor_heal=4, armor_use=250},
	wear = 0,
})
...
minetest.register_tool("shields:shield_diamond", {
	...
	groups = {armor_shield=9, armor_heal=6, armor_use=100},
	wear = 0,
})
...
minetest.register_tool("shields:shield_mithril", {
	...
	groups = {armor_shield=11, armor_heal=8, armor_use=50},
	wear = 0,
})
